...
<img src="/img/environments-protected.png" alt="Protected Environment" className="image" />
...
<img src="/img/env-enable-protection.png" alt="Enable Protection" className="image" />
