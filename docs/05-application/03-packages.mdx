...
Packages are created automatically when you push a new commit to the repository. All packages are avialiable for every
environment.
...
Some of the package details are available in the `Packages` table. There you can see the package name, version, jobs
(vulnerability scanning, linting, unit tests), created at date, and actions.

To view the all details of a package click the package name.

<img src="/img/package-details.png" alt="Package Details" className="image" />

### Package Description

You can give a package a description to help you identify it. Simple open action menu in the `Packages table` and click
`Edit description`.
...
You can see the Vulnerabilities summary in the Packages screen under the `job` column. Also you can navigate to the
...
You can see the Best Practices summary in the Packages screen under the `job` column. Also you can navigate to the
...
You can see the Unit Testing summary in the Packages screen under the `job` column. Also you can navigate to the package
