...
Package approval works only in protected environments. To learn more about protected environments, see
[Protected Environments](/docs/application/environments#protected-environments).
...
<img src="/img/package-approval.png" alt="Package approval" className="image" />

If the package is not approved, you can't deploy it to the protected environment.

<img src="/img/package-approval-deploy.png" alt="Package approval" className="image" />
