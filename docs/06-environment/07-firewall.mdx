...
The firewall (IP filtering) helps you `restrict` or `allow` application access to specific IP address or IP ranges.
...
You can edit firewall rule byt clicking the `Edit` button on the firewalls table action menu.

<img src="/img/firewall-action-menu.png" alt="Edit Firewall Rule" className="image" />

### Delete Firewall Rule

You can delete a firewall rule by clicking the `Delete` button on the firewalls action table menu.
