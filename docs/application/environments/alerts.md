...
1. Locate the "Status" column
2. This column indicates if the application is running without problems or if any issues have occurred
    
    <img src="../../../assets/images/alerts.jpg" width="500" alt="Alerts tab">
