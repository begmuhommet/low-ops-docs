...
4. In the left-side menu, select Logs.

<img src="../../../assets/images/logs.jpg" width="500" alt="Logs tab">

## Configuring Log Levels

1. Click the "Configure Log Levels" button in the upper right corner.

<img src="../../../assets/images/configure_log_levels.jpg" width="500" alt="Configure log levels">

2. In the pop-up window, click the "Add log level" buton.

<img src="../../../assets/images/add_log_level.jpg" width="500" alt="Configure log levels">
