...
### Instructions
   ...
   <img src="../../assets/images/mx8_git_clone_repo.png" width="500" alt="Clone Mendix Project">
   - Launch Mendix Studio Pro and click on "Open App".
   <img src="../../assets/images/mx8_open_app.png" width="500" alt="Open Mendix Studio Pro">
   - Choose the "Locally on Disk" option.
   <img src="../../assets/images/mx8_local_disk.png" width="500" alt="Select Locally on Disk">
   - Navigate to the directory where the project was cloned and select the .mpr file.
   <img src="../../assets/images/mx8_open_mpr.png" width="500" alt="Navigate to Cloned Project">
   ...
   <img src="../../assets/images/mx8_git_add_commit_push.png" width="500" alt="Commit and Push Changes">
