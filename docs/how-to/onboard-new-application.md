...
1. On the home page, click on the `Create app` buton. 

![](../assets/create_new_application.jpg)

2. In the pop up window, fill in the fields for the `App name` and `App tenant` and click on the `Create app` button. 
