...
<img src="../../../assets/create_new_application.jpg" width="500" alt="Create new application button">
...
<img src="../../../assets/component_creating.jpg" width="500" alt="Application creation in progress">

5. Once the application is created, it will appear in the list of apps on the home page.

<img src="../../../assets/component_created.jpg" width="500" alt="New application in the app list">
