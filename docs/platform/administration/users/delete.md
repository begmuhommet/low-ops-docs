...
<img src="../../../assets/delete_user.jpg" width="500" alt="Delete user section in user profile">

5. Click the "Delete user" button.
6. In the pop-up window, click the "Delete" button to confirm the deletion.

<img src="../../../assets/deleting_user.jpg" width="500" alt="Delete user confirmation pop-up">
