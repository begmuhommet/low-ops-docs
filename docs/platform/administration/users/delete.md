...
<img src="../../../../assets/images/administration.jpg" width="500" alt="Administration tab">
...
<img src="../../../../assets/images/delete_user.jpg" width="500" alt="Delete user section in user profile">

5. Click the "Delete user" button.
6. In the pop-up window, click the "Delete" button to confirm the deletion.

<img src="../../../../assets/images/deleting_user.jpg" width="500" alt="Delete user confirmation pop-up">
